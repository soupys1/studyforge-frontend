      ...
      >
        <div
          ...
          style={{
            ...
            animation: "sf-in 0.18s ease forwards",
            position: "relative",
          }}
        >
          {/* Close */}
          <button
            ...
            onMouseEnter={e => (e.currentTarget.style.color = "var(--ln-ink-subtle)")}
            onMouseLeave={e => (e.currentTarget.style.color = "var(--ln-ink-tertiary)")}
            aria-label="Close"
          >
            ×
          </button>

          <p className="sf-kicker" style={{ marginBottom: 6 }}>
            {mode === "signin" ? "Welcome back" : "Create account"}
          </p>
          <h2 style={{ fontSize: 20, fontWeight: 600, marginBottom: 24, letterSpacing: "-0.02em", color: "var(--ln-ink)" }}>
          ...
          <div style={{
            ...
            <div style={{ flex: 1, height: 1, background: "var(--ln-hair)" }} />
            or
            <div style={{ flex: 1, height: 1, background: "var(--ln-hair)" }} />
          </div>
          ...
          {/* Toggle mode */}
          <p style={{ marginTop: 18, textAlign: "center", fontSize: 13, color: "var(--ln-ink-subtle)" }}>
